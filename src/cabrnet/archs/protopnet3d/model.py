...
class ProtoPNet3D(CaBRNet):
    ...
    def __init__(self, extractor: nn.Module, classifier: CaBRNetClassifier, **kwargs):
        ...
        """
        super(ProtoPNet3D, self).__init__(extractor, classifier, **kwargs)
    ...
    def train_epoch(
        ...
        r"""Trains a ProtoPNet3D model for one epoch, performing prototype projection and fine-tuning if necessary.
